        ...
        ApplicationLoadBalancedFargateService aluraService = ApplicationLoadBalancedFargateService.Builder.create(this, "AluraService")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                //.image(ContainerImage.fromRegistry("vcmarini/pedidos-ms")) // imagem pega a imagem do docker hub
                                .image(ContainerImage.fromEcrRepository(iRepository)) // imagem pega do ECR na aws
                                .containerPort(8080)
                                .containerName("app-pedidos")
